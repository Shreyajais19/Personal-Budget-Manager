...
public class incomeAdapter2 extends RecyclerView.Adapter<incomeAdapter2.viewholder> {
    ...
    public viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_budget_item2, parent, false);
    ...
    public void showIncomeDialog(Context context, incomeModel model) {
        ...
        final View customLayout = LayoutInflater.from(context).inflate(R.layout.budget_add_litem, null);
